...
| Platform | State |
|---|---|
| macOS arm64 (`maca64`) | Builds, loads, 156/156 tests pass. Verified locally against Homebrew ITK and in CI against static ITK, including the full suite on a runner with **no ITK installed**. |
| Linux x86_64 (`glnxa64`) | Builds, loads, 156/156 tests pass. Verified in CI against static ITK, including the full suite on a runner with **no ITK installed**. Must be built with GCC 12 or older; see BUILDING.md. |
