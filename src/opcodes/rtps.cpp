 ...
 public:
  ...
  const char* StatusNote() const override {
    return "Epic 4 Phase 1's original implementation (split-in-half "
           ...
           "Six of the eight successful captures reproduce at the "
           "floating-point noise floor (RMS <= ~5.3e-12): "
           "rtps_nc5_identity_double, rtps_nc5_translate_double, "
           "rtps_pairs4_translate_double, rtps_coplanar3_distinct_double, "
           "rtps_pairs3_distinct_double. The remaining two "
           ...
           "well-spread pairs) is likewise exact (RMS 5.26e-12). "
           ...
           "wiring error: six captures spanning coplanar and non-coplanar, "
           "identity and translation, and symmetric and asymmetric "
           "volumes all reproduce exactly under the identical wiring, "
           "which rules out a systematic error as the source of the "
           "remaining three residuals. All eight successful captures and "
